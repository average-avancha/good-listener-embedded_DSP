...
JNIEXPORT void JNICALL
        Java_com_ece420_lab4_MainActivity_createSLEngine(JNIEnv *env, jclass, jint, jint);
JNIEXPORT void JNICALL
        Java_com_ece420_lab4_MainActivity_deleteSLEngine(JNIEnv *env, jclass type);
JNIEXPORT jboolean JNICALL
        Java_com_ece420_lab4_MainActivity_createSLBufferQueueAudioPlayer(JNIEnv *env, jclass);
JNIEXPORT void JNICALL
        Java_com_ece420_lab4_MainActivity_deleteSLBufferQueueAudioPlayer(JNIEnv *env, jclass type);

JNIEXPORT jboolean JNICALL
        Java_com_ece420_lab4_MainActivity_createAudioRecorder(JNIEnv *env, jclass type);
JNIEXPORT void JNICALL
        Java_com_ece420_lab4_MainActivity_deleteAudioRecorder(JNIEnv *env, jclass type);
JNIEXPORT void JNICALL
        Java_com_ece420_lab4_MainActivity_startPlay(JNIEnv *env, jclass type);
JNIEXPORT void JNICALL
        Java_com_ece420_lab4_MainActivity_stopPlay(JNIEnv *env, jclass type);
}

JNIEXPORT void JNICALL
Java_com_ece420_lab4_MainActivity_createSLEngine(
...
JNIEXPORT jboolean JNICALL
Java_com_ece420_lab4_MainActivity_createSLBufferQueueAudioPlayer(JNIEnv *env, jclass type) {
...
Java_com_ece420_lab4_MainActivity_stopPlay(JNIEnv *env, jclass type) {
    ...
    speaker_identification();//TODO: Update function call as it improves
}
